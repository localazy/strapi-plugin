          ...
          <Layout sideNav={renderSideNav && <SideNav />}>
            ...
            {!isLoadingApp && (
              <>
                {!isLoggedIn && (
                  <Switch>
                    <Route path={`${process.env.STRAPI_ADMIN_LOCALAZY_PLUGIN_BACKEND_PREFIX}${process.env.ADMIN_PATH}plugins/${pluginId}/login`} exact>
                      <Login
                        title={headerTitle}
                ...
                {isLoggedIn && (
                  <Switch>
                    <Route path={`${process.env.STRAPI_ADMIN_LOCALAZY_PLUGIN_BACKEND_PREFIX}${process.env.ADMIN_PATH}plugins/${pluginId}/download`} exact>
                      <Download
                        title={headerTitle}
                        subtitle={headerSubtitle}
                      />
                    </Route>
                    <Route path={`${process.env.STRAPI_ADMIN_LOCALAZY_PLUGIN_BACKEND_PREFIX}${process.env.ADMIN_PATH}plugins/${pluginId}/upload`} exact>
                      <Upload
                        title={headerTitle}
                        subtitle={headerSubtitle}
                      />
                    </Route>
                    <Route path={`${process.env.STRAPI_ADMIN_LOCALAZY_PLUGIN_BACKEND_PREFIX}${process.env.ADMIN_PATH}plugins/${pluginId}/settings`} exact>
                      <Settings
                        title={headerTitle}
                        subtitle={headerSubtitle}
                      />
